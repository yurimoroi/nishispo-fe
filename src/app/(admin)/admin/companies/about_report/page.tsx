...
export default async function Page() {
  ...
  const dataContent = DOMPurify.sanitize(data.about_report);
  const editPageLink = "/admin/companies/about_report/edit";

  return (
    <MainBlock>
      <PageTitle className="text-3xl">掲載内容について</PageTitle>
      <PageContent>
        <div
