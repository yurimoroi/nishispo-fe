...
export default async function Page() {
  ...
  const dataContent = DOMPurify.sanitize(data.reporter_editor);
  const editPageLink = "/admin/companies/work/reporter_editor/edit";

  return (
    <MainBlock>
      <PageTitle className="text-3xl">記者・編集部員募集</PageTitle>
      <PageContent>
        <div
