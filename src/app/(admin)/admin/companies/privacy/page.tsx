...
export default async function Page() {
  ...
  const dataContent = DOMPurify.sanitize(data.privacy_policy);
  const editPageLink = "/admin/companies/privacy/edit";

  return (
    <MainBlock>
      <PageTitle className="text-3xl">プライバシーポリシー</PageTitle>
      <PageContent>
        <div
