...
export default async function Page() {
  ...
  const { data: reportData } = companyDataResponse;
  const dataContent = DOMPurify.sanitize(reportData.reporter_editor);
  return (
    <>
